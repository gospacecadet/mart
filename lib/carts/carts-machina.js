  ...
  machina: function() {
    ...
    fsm.states[Mart.Cart.STATES.PROCESSING_TRANSFER] = {
      _onEnter: function() {
        ...
        var firstLineItem = Mart.LineItems.findOne({cartId: this._._id})
        var firstProduct = Mart.Products.findOne(firstLineItem.productId)
        var firstStorefront = Mart.Storefronts.findOne(firstProduct.storefrontId)
        ...
        try {
          ...
          Mart.Carts.update(this._._id, {$set: {
            ...
            transferredToManagedAccountId: bankAccount._id
          }})
