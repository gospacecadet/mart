_.extend(Cart.prototype, {
  machina: function() {
    ...
    fsm.states[Mart.Cart.STATES.WAITING_CART_ACCEPTANCE] = {
      ...
      "acceptCart": function() {
        if(this._.firstLineItem().unit === Mart.Product.UNITS.MONTH) {
    ...
    fsm.states[Mart.Cart.STATES.WAITING_TRANSFER_ACCEPTANCE] = {
      _onEnter: function() {
        ...
        Email.send({
          ...
          "and your request to dock at " + this._.storefrontNameAtCheckout + " has been approved by the Station Commander. " +
          "The details of your docking are below.\n\n" +
          "Reservation Number: " + this._._id +
          "\n" + docking.padName + " at " + docking.stationName + "\n" +
          "\n" + this._.addressAtCheckout + " " + this._.cityAtCheckout + ", " + this._.stateAtCheckout +
          ...
          "\nService Fee = " + accounting.formatMoney(this._.serviceFeeAtCheckout/100) +
          "\nTotal  = " + accounting.formatMoney(this._.totalAtCheckout/100) +
          "\n\nHappy Renting!\n" +
          "The Space Cadets"
        });
    ...
    fsm.states[Mart.Cart.STATES.CANCELLED_BY_MERCHANT] = {
      _onEnter: function() {
        ...
        Email.send({
          ...
          text: "Greetings Captain " + pName(this._.id) + "," +
