  ...
  "mart/update-user": function(userDetails) {
    ...
    check(userDetails, {
      ...
      profile: {
        ...
        dobMonth: Match.Optional(Number),
        dobDay: Match.Optional(Number),
        dobYear: Match.Optional(Number),
        typeOnGateway: Match.Optional(String)
      }
    })
    var userId = Meteor.userId()
    if(userId) {
      ...
      return Meteor.users.update(userId, {$set: {
        ...
        "profile.dobMonth": profile.dobMonth,
        "profile.dobDay": profile.dobDay,
        "profile.dobYear": profile.dobYear,
        "profile.typeOnGateway": profile.typeOnGateway,
      }})
